...
require "/media/junlysky/00028BD3000AFE03/autocap/perlbin/gcap_plt.pl";	# include plot script

#================defaults======================================
$cmd = "gcap";
$green = "Glib";	#green's function location
$repeat = 0;
$bootstrap = 0;
$fm_thr = 0.01;
$dirct='';
...
foreach $eve (@event) {
  ...
  $cmd = "gcap$dirct $eve $md_dep" unless $cmd eq "cat";
